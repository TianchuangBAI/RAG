...
# 加载、处理数据集和测试集
train_dataset_path = "train_en.jsonl"
test_dataset_path = "val_en.jsonl"

train_jsonl_new_path = "train_format_en.jsonl"
test_jsonl_new_path = "val_format_en.jsonl"
...
args = TrainingArguments(
    output_dir="./output/Qwen3-14B-en",
